...
Test file `tests/cases.test.ts` contains tests and validation symbols. Key symbols: `stripAnsi`, `casesDir`, and 3 more.

- Symbols: `stripAnsi (const)`, `casesDir (const)`, `caseDir (function)`, `latDir (function)`, `testCtx (function)`
